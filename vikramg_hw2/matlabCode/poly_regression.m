...
for i=1:degree
    extended_train_X = [extended_train_X train_data_X.^i];
    extended_test_X = [extended_test_X test_data_X.^i];
end
...
% lambda = exp(-18);
% c= ones(1,dimension)
% weights = regularizedregression(extended_train_X, train_data_Y, c, lambda)
